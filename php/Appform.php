...
// *********************************
//社会实践报名表单
	// session_start();//打开session文件 默认打开
	...
	error_reporting(E_ERROR | E_WARNING | E_PARSE);
 	...
 	if(isset($_REQUEST["AppSno"]))
 	{
		...
		else page_redirect(1,"SocialPractice.php","用户未注册！");
	}
		...
		if(mysqli_affected_rows($conn)>0)
		{
			...
			page_redirect(1,"SocialPractice.php","报名成功！");

		}
		else
		{
			page_redirect(1,"SocialPractice.php","您已报名！请勿重复报名！");
		}
